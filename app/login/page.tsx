  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="mb-4 text-sm muted">ou</div>
        <button 
          type="button" 
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
            <path fill="#4285F4" d="M533.5 278.4c0-18.5-1.6-36.3-4.6-53.6H272v101.4h146.9c-6.3 34.1-25.1 63-53.6 82.3v68.3h86.6c50.8-46.8 81.6-115.9 81.6-198.4z"/>
            <path fill="#34A853" d="M272 544.3c72.6 0 133.6-24.1 178.1-65.5l-86.6-68.3c-24.1 16.2-55 25.9-91.5 25.9-70.2 0-129.7-47.4-151-111.2H34.9v69.9C79.3 486 170.9 544.3 272 544.3z"/>
            <path fill="#FBBC05" d="M121 326.2c-10.9-32.9-10.9-68.4 0-101.3V154.9H34.9C12.6 200.2 0 246.0 0 278.4s12.6 78.2 34.9 123.5L121 326.2z"/>
            <path fill="#EA4335" d="M272 108.1c38.9 0 74 13.4 101.5 39.6l76.1-76.1C402.8 24.5 345.2 0 272 0 170.9 0 79.3 58.3 34.9 154.9l86.1 69.9C142.3 155.5 201.8 108.1 272 108.1z"/>
          </svg>
          <span>Entrar com Google</span>
        </button>
        {message && <p className="mt-4 text-sm text-center muted">{message}</p>}
      </div>
    </div>
  )
}
